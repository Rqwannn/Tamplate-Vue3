    ...
    <section class="container">
      <form @submit.prevent="addGoal">
        <div>
          ...
          <input ref="input" type="text" id="goaltext" v-model="enteredText" />
        </div>
  ...
  export default {
    ...
    setup(_, context) {
      ...
      function addGoal() {
        ...
        enteredText.value = "";
        // input.value.value = "Test" INTINYA CARA GUNAIN REFS DI VUE 3 COMPO API
      }
  
      return {
        input, // Supaya bisa di gunakan di tamplate
        enteredText,
        invalidInput,
        addGoal,
      };
